									...
									<tbody>
										<c:forEach var="emp" items="${empAllList}">
											<tr>
												...
												<td>
													<c:out value="${emp.department.deptName}" />
												</td>
												<td>
													<c:out value="${emp.phone}" />
												</td>
												<td>
													<c:out value="${emp.mailAddress}" />
												</td>
												<td>
													<form action="<%=request.getContextPath()%>/empupdateselectbutton"
														method="post">
												...
												<td>
													<form action="<%=request.getContextPath()%>/empdeleteselectbutton"
														method="post">
														<input type="hidden" name="empId" value="${emp.empId}">
