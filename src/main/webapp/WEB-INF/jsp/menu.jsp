				...
				<div class="card text-center">
					<div class="card-body">
						...
						<ul class="nav justify-content-center">
							<li class="nav-item m-3"><a href="<%=request.getContextPath()%>/emplist"
									class="btn btn-primary btn-lg"> 社員一覧 </a></li>
							<li class="nav-item m-3"><a href="<%=request.getContextPath()%>/empregistinput"
									class="btn btn-primary btn-lg"> 社員登録 </a></li>
						</ul>
						<br>
						<br>
						<ul class="nav justify-content-center">
							<li class="nav-item m-3"><a href="<%=request.getContextPath()%>/deptlist"
									class="btn btn-primary btn-lg"> 部門一覧 </a></li>
							<li class="nav-item m-3"><a href="<%=request.getContextPath()%>/deptregistinput"
